...
class SubscribersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscriber" do
    assert_difference('Subscriber.count') do
      post subscribers_url, params: { subscriber: { email: @subscriber.email, first_name: @subscriber.first_name, last_name: @subscriber.last_name } }
    end
  ...
  test "should update subscriber" do
    patch subscriber_url(@subscriber), params: { subscriber: { email: @subscriber.email, first_name: @subscriber.first_name, last_name: @subscriber.last_name } }
